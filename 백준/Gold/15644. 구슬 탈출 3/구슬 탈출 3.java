...
public class Main {
	...
	public static class Board{
		...
		public Board(char[][] board, int num, int r, int c, char prev, String cmd) {
			this.board = board;
			this.num = num;
			this.r = r;
			this.c = c;
		...
		public Board Up() {
			...
			return new Board(res_board, res_num, nr, nc, prev, cmd+'U');
		}
		...
		public Board Down() {
			...
			return new Board(res_board, res_num, nr, nc, prev, cmd+'D');
		}
		...
		public Board Left() {
			...
			return new Board(res_board, res_num, nr, nc, prev, cmd+'L');
		}
		...
		public Board Right() {
			...
			return new Board(res_board, res_num, nr, nc, prev, cmd+'R');
		}
	}
